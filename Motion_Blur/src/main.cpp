...
int main(int, char**)
{
    ...
    Object *sphere1 = new Sphere(Vector3D(-3, 2, -4), 1, m1);
    world->addObject(sphere1);

    // Object *sphere2 = new Sphere(Vector3D(3, 2, 1), 1, m);
    // world->addObject(sphere2);

    // Object *sphere3 = new Sphere(Vector3D(0, 0, 1), 1, m1);
   ...
   // Triangle
    ...
    // Object *triangle1 = new Triangle(Vector3D(-3, 1, -4), Vector3D(1, 1, -4), Vector3D(-1, 2, -4), m1);
