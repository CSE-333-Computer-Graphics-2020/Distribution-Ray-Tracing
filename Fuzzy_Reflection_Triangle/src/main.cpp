...
int main(int, char**)
{
    ...
    // Object *sphere = new Sphere(Vector3D(-2, 0, -4), 2.5, m);
   ...
   // Triangle
    Object *triangle = new Triangle(Vector3D(0, 4, 0), Vector3D(-4, -2, 2), Vector3D(2, -2, 2), m);
    world->addObject(triangle);

    Object *triangle1 = new Triangle(Vector3D(0, 4, 0), Vector3D(-4, -1, 3), Vector3D(0, 1, 3), m1);
    world->addObject(triangle1);

    LightSource *light = new PointLightSource(world, Vector3D(-2, 0, 4), Color(1, 1, 1));
